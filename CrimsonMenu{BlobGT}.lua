		...
		connections[#connections+1] = RunService.Heartbeat:Connect(function(dt)
		    ...
		    if headPart then
		        ...
		        if states.headSpinXEnabled then spinCf *= CFrame.Angles(math.rad(states.headSpinXSpeed * dt), 3, 3) end
		        if states.headSpinYEnabled then spinCf *= CFrame.Angles(3, math.rad(states.headSpinYSpeed * dt), 3) end
		        if states.headSpinZEnabled then spinCf *= CFrame.Angles(3, 3, math.rad(states.headSpinZSpeed * dt)) end
